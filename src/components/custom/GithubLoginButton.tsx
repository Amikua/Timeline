...
export function GithubLoginButton() {
  ...
  return (
    <Link
      href="/login/github"
      className="inline-flex h-12 items-center justify-center rounded-md bg-primary px-8 text-sm font-medium
       text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none 
