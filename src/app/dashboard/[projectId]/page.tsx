...
function SettingsPageLink({ projectId }: { projectId: string }) {
  return (
      <Link
...
function PrintPageLink(params: { projectId: string }) {
  return (
    <Link
      href={`/print/${params.projectId}`}
      className="absolute right-4 top-16 hover:brightness-75 text-foreground"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="2em"
...
export default async function Page({
  ...
  return (
    <>
      <SettingsPageLink projectId={projectId} />
      <PrintPageLink projectId={projectId} />
      <Timeline
